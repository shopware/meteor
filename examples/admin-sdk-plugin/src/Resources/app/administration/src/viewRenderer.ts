...
const app = createApp({
    ...
    components: {
        ...
        'UiMainModuleAddMainModule': defineAsyncComponent(() => import('./views/ui/main-module/add-main-module')),
        // ui/menu-item/
        'UiMenuItemAddMenuItem': defineAsyncComponent(() => import('./views/ui/menu-item/add-menu-item')),
        'UiMenuItemAddMenuItemWithSearchBar': defineAsyncComponent(() => import('./views/ui/menu-item/add-menu-item-with-searchbar')),
        // ui/modals
        'UiModals': defineAsyncComponent(() => import('./views/ui/modals/modals')),
        'UiModalsModalContent': defineAsyncComponent(() => import('./views/ui/modals/modal-content')),
        // location/general
