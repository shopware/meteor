<template>
  <div style="padding: 20px">
    ...
    <div>
      ...
      <sw-button @click="getShopwareVersion"
        >Get current Shopware version</sw-button
      >

      <p>Shopware version: {{ shopwareVersion }}</p>
    </div>
    ...
    <div>
      ...
      <sw-button @click="getModuleInformation"
        >Get module information</sw-button
      >
    ...
    <div>
      ...
      <br />
      <sw-text-area
        label="Push route information"
        cols="30"
        rows="10"
        v-model="routeInformation"
      ></sw-text-area>
    </div>
    ...
    <div>
      ...
      <sw-button @click="dispatchNotification"
        >Dispatch a notification</sw-button
      >
    </div>
    ...
    <div id="dbquery">
      ...
      <sw-text-field
        v-if="apiLanguageEntity"
        name="apilanguage"
        id="apiLanguage"
        v-model="apiLanguageEntity.name"
      />
      <sw-button @click="saveApilanguage" id="saveusername"
        >Save name</sw-button
      >
    </div>
  </div>
...
import {
  ...
  data,
  window,
} from "@shopware-ag/meteor-admin-sdk";
import {
  SwButton,
  SwTextField,
  SwTextarea,
      ...
      routeInformation: `
{
  ...
  methods: {
    ...
    getCurrency() {
      context
        .getCurrency()
        .then(({ systemCurrencyId, systemCurrencyISOCode }) => {
