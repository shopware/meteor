...
<ComponentPageHeader
  title="Text Editor"
  tagName="mt-text-editor"
  packageImports="MtTextEditor"
  sourcePath="packages/component-library/src/components/form/mt-text-editor"
>
  The **Text Editor** component is a powerful and flexible rich text editor
  built with [Tiptap](https://tiptap.dev/). It is designed to handle a variety
  of use cases, such as adding rich text editing to your application. This
  component is highly customizable and can be extended with additional buttons,
  features, or configurations to suit your needs.
</ComponentPageHeader>
...
To use the **Text Editor** component in your project, import it and provide the required props.
...
The **Text Editor** component provides several slots for customization:
...
The **Text Editor** includes the following built-in buttons by default:
...
The editor uses [Tiptap extensions](https://tiptap.dev/docs/editor/core-concepts/extensions) for its features.
...
The **Text Editor** supports adding custom buttons to the toolbar by passing an array of `CustomButton` objects to the `customButtons` prop.
...
The **Text Editor** includes a code editor mode for editing raw HTML. This mode is powered by [CodeMirror](https://codemirror.net/). Use the `toggle-code` button to switch between WYSIWYG mode and code mode.
