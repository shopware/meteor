...
const defaultButtons: CustomButton[] = [
  ...
  {
    name: 'bold',
    label: t('mt-text-editor-toolbar.buttons.bold'),
  ...
  {
    name: 'italic',
    label: t('mt-text-editor-toolbar.buttons.italic'),
  ...
  {
    name: 'underline',
    label: t('mt-text-editor-toolbar.buttons.underline'),
  ...
  {
    name: 'strikethrough',
    label: t('mt-text-editor-toolbar.buttons.strikethrough'),
  ...
  {
    name: 'superscript',
    label: t('mt-text-editor-toolbar.buttons.superscript'),
  ...
  {
    name: 'subscript',
    label: t('mt-text-editor-toolbar.buttons.subscript'),
  ...
  {
    name: 'text-alignment',
    label: t('mt-text-editor-toolbar.buttons.text-alignment'),
    icon: 'regular-align-left-xs',
    children: [
      {
        name: 'align-left',
        label: t('mt-text-editor-toolbar.buttons.align-left'),
        action: () => props.editor.chain().focus().setTextAlign('left').run(),
        isActive: editor => editor.isActive({ textAlign: 'left' }),
      },
      {
        name: 'align-center',
        label: t('mt-text-editor-toolbar.buttons.align-center'),
        action: () => props.editor.chain().focus().setTextAlign('center').run(),
        isActive: editor => editor.isActive({ textAlign: 'center' }),
      },
      {
        name: 'align-right',
        label: t('mt-text-editor-toolbar.buttons.align-right'),
        action: () => props.editor.chain().focus().setTextAlign('right').run(),
        isActive: editor => editor.isActive({ textAlign: 'right' }),
      },
      {
        name: 'justify',
        label: t('mt-text-editor-toolbar.buttons.justify'),
  ...
  },
  {
    ...
    label: t('mt-text-editor-toolbar.buttons.unordered-list'),
  ...
  },
  {
    ...
    label: t('mt-text-editor-toolbar.buttons.numbered-list'),
  ...
  },
  {
    ...
    alignment: 'right',
    label: t('mt-text-editor-toolbar.buttons.undo'),
  ...
  },
  {
    ...
    alignment: 'right',
    label: t('mt-text-editor-toolbar.buttons.redo'),
...
watch(contextualButtons, (newValue, oldValue) => {
