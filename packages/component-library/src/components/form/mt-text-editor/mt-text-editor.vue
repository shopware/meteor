      ...
      <div class="mt-text-editor__footer">
        ...
        <div class="mt-text-editor__footer-right">
          <slot name="footer-right" :editor="editor">
            {{ t('mt-text-editor.footer.characters', editor.storage.characterCount.characters()) }}
          </slot>
        </div>
      </div>
    </div>
...
import mtTextEditorToolbarButtonColor, { colorButton } from './_internal/mt-text-editor-toolbar-button-color.vue';
import mtTextEditorToolbarButtonLink, { linkButton } from './_internal/mt-text-editor-toolbar-button-link.vue';
import mtTextEditorToolbarButtonTable, { tableButton } from './_internal/mt-text-editor-toolbar-button-table.vue';
...
const mergedCustomButtons = computed<CustomButton[]>(() => {
  const editorButtons: CustomButton[] = [
    ...
    {
      name: 'toggle-code',
      label: t('mt-text-editor.buttons.toggle-code'),
