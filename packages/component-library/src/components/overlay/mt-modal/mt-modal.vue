  ...
  <transition name="modal">
    ...
    >
      ...
      <div class="mt-modal__content" ref="modalContentRef">
        ...
        <div class="mt-modal__content-inner">
          <slot name="default" />
        </div>
...
.mt-modal__content {
  --mt-modal-padding: 1.5rem;
  --inset-top: var(--mt-modal-padding);
  --inset-right: var(--mt-modal-padding);
  --inset-bottom: var(--mt-modal-padding);
  --inset-left: var(--mt-modal-padding);
