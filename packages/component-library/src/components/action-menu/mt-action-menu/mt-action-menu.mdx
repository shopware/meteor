  ...
  <mt-dropdown-menu-root>
    ...
    <mt-dropdown-menu-portal>
      <mt-action-menu>
        ...
        <mt-action-menu-group>
          <mt-action-menu-item icon="settings">Settings</mt-action-menu-item>
...
Display keyboard shortcuts alongside menu items using the `shortcut` prop:
...
| ----------- | --------- | ------- | ---------------------------------------------------- |
| `isSubMenu` | `boolean` | `false` | Set to `true` when used inside a `MtDropdownMenuSub` |
...
| `variant`      | `'default' \| 'critical'`     | `'default'` | Visual variant for the item                  |
| `disabled`     | `boolean`                     | `false`     | Whether the item is disabled                 |
| `shortcut`     | `{ pc: string, mac: string }` | `undefined` | Keyboard shortcut to display                 |
| `isSubTrigger` | `boolean`                     | `false`     | Set to `true` when this item opens a submenu |

### `MtActionMenuGroup`

Groups related menu items with a visual divider.
