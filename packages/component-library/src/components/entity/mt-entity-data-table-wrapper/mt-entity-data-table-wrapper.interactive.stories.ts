import meta, { type MtEntityDataTableWrapperMeta } from './mt-entity-data-table-wrapper.stories';
...
export default {
  ...meta,
  title: 'Interaction Tests/Entity/mt-entity-data-table-wrapper',
} as MtEntityDataTableWrapperMeta;

type MtEntityDataTableWrapperStory = StoryObj<MtEntityDataTableWrapperMeta>;
...
export const VisualTestRenderTable: MtEntityDataTableWrapperStory = {
...
export const VisualTestRenderFullLayout: MtEntityDataTableWrapperStory = {
...
export const VisualTestRenderEmptyState: MtEntityDataTableWrapperStory = {
...
// Data Operations
export const InteractionTestPaginationChangePage: MtEntityDataTableWrapperStory = {
...
export const InteractionTestPaginationChangeLimit: MtEntityDataTableWrapperStory = {
...
export const InteractionTestSorting: MtEntityDataTableWrapperStory = {
...
export const InteractionTestSearch: MtEntityDataTableWrapperStory = {
...
// Filtering
export const InteractionTestApplyBooleanFilter: MtEntityDataTableWrapperStory = {
...
export const InteractionTestApplyMultiSelectFilter: MtEntityDataTableWrapperStory = {
  ...
  play: async ({ canvasElement, args }) => {
    ...
    const manufacturerOption = await dialogContent.findByRole('menuitem', { name: 'Gibson - Predovic' });
    ...
    const tableContent = within(document.querySelector('.mt-data-table__table-wrapper') as HTMLElement);
    await expect(tableContent.getByText('Gibson - Predovic')).toBeInTheDocument();
  },
};

export const InteractionTestClearFilter: MtEntityDataTableWrapperStory = {
...
// Event Emissions
export const InteractionTestEmitOpenDetails: MtEntityDataTableWrapperStory = {
  ...
  play: async ({ canvasElement, args }) => {
    ...
    expect(args.onOpenDetails).toHaveBeenCalledWith(productFixtures.find(product => product.name === 'Fantastic Cotton Sausages'));
  },
};

export const InteractionTestEmitBulkEdit: MtEntityDataTableWrapperStory = {
...
export const InteractionTestEmitBulkDelete: MtEntityDataTableWrapperStory = {
...
export const VisualTestDeleteModal: MtEntityDataTableWrapperStory = {
  name: 'Should render the delete modal',
  play: async ({ canvasElement, args }) => {
    await waitForLoadingComplete(canvasElement);
    // Click on context button in first row
    const firstRow = within(canvasElement.querySelector('table > tbody > tr:nth-child(1)') as HTMLElement);
