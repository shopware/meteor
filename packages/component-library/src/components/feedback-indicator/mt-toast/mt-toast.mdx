...
<Meta of={ToastStories} title="Components/mt-toast" />

<ComponentPageHeader
  title="Toast"
  tagName="mt-toast"
  status="deprecated" packageImports="MtToast" 
  sourcePath="packages/component-library/src/components/feedback-indicator/mt-toast"
>
