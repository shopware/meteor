...
<DoDont
  ...
  dont="Use a large arbitrary value like border-radius: 999px or 50%."
/>

<DoDont
  do="Use border-radius tokens for corner radii."
  dont="Use scale tokens (--scale-size-*) for border-radius. Using scale directly removes the semantic layer and doesn't allow for theming or updates on border radius tokens."
/>
