...
<Meta title="Foundations/Content/Wording" />

<StorybookPageHeader status="none" title="Wording" />
...
<DoDont
  do="Jennifer logged into the account"
  dont="The account was logged into by Jennifer"
/>

<DoDont
  do="Invoices are created monthly and emailed to j.miller@acme.inc"
  dont="Shopware creates and emails your invoices monthly to j.miller@acme.inc"
/>
...
<DoDont do='"allowlist" and "blocklist"' dont='"whitelist" and "blacklist"' />

<DoDont do='"main", "primary"' dont='"master"' />

### Gender

<DoDont do='"they"' dont='"him" or "her", "he" or "she"' />

<DoDont do='"people", "folks", "teammates"' dont='"guys"' />

<DoDont
  do="Neutral, straightforward titles"
  dont='"ninja", "rockstar", "wizard"'
/>

<DoDont do='"workforce"' dont='"manpower"' />

### Sexual orientation and gender identity

<DoDont
  do='"spouse" or "partner"'
  dont='"wife/husband" or "girlfriend/boyfriend"'
/>
...
<DoDont
  do="We've made some changes to improve your store's security"
  dont="We've activated your SSL certificates"
/>
...
<DoDont do="Save" dont="Click here to save" />

If the context alone does not make the action clear, add a noun and, if necessary, a preposition.

<DoDont do="Save product" dont="Save the product" />

<DoDont do="Continue to checkout" dont="Continue to the checkout" />
...
Required field labels use the word "required" only when most fields in the form are optional. When most fields are required, mark the exceptions as "optional" instead.

For broader message writing guidelines covering errors, success, warnings, and info messages, see the [Messaging](?path=/docs/foundations-content-messaging--docs) page.

## Glossary

For a full reference of approved English and German terms, see the [Glossary](?path=/docs/foundations-content-glossary--docs) page.
