...
import TokenBrowser from "../_components/token-browser.js";
import StorybookPageHeader from "../_components/storybook-page-header.js";

<Meta title="Foundations/Tokens/Overview" />

<StorybookPageHeader
  status="none"
  title="Tokens"
  sourcePath="packages/tokens"
  npmPackage="@shopware-ag/meteor-tokens"
/>
...
- The intended value in light and dark themes
...
If you do need to override, do so after importing the Meteor token files and scope changes to `[data-theme="dark"]` for dark theme variants.
