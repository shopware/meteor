...
<DoDont
  do="The customer placed the order"
  dont="The order was placed by the customer"
/>
...
<DoDont
  do="Your store now supports cross-border payments through the Open Banking protocol."
  dont="Your store now supports cross-border payments through OBP."
/>
