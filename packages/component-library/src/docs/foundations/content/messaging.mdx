...
<DoDont do="Enter a valid email address." dont="Invalid email." />

<DoDont
  do="Password must be at least 8 characters."
  dont="Password is too short."
/>
...
<DoDont
  do="Must be at least 8 characters and include a number."
  dont="Enter your password."
/>
...
<DoDont
  do="Unsaved changes will be lost if you leave this page."
  dont="Warning: You have unsaved changes!"
/>

<DoDont
  do="This product will be removed from all associated Sales Channels and cannot be restored."
...
Use the [Empty State](?path=/docs/components-empty-state--docs) component wherever possible.
