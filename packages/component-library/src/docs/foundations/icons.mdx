...
Meteor icons follow a minimal, expressive style aligned with Shopware's product language. The set is built for consistency, clarity, and legibility across all sizes and themes.
...
For technical usage, see the [Icon component](?path=/docs/components-icon--docs) documentation.
