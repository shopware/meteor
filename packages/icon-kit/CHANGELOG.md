...
- [#1187](https://github.com/shopware/meteor/pull/1187) [`54f20ca`](https://github.com/shopware/meteor/commit/54f20cafd3e586303bed2fdc0e3a9df59773e6f0) Thanks [@arnoldstoba](https://github.com/arnoldstoba)! - Replace the generated SCSS stylesheet with pure CSS. Import `icons/meteor-icon-kit.css` — stable filename, fixed `px` units. The hash-suffixed `meteor-icon-kit-<hash>.css` file is no longer generated. The old `icons/meteor-icon-kit.scss` path still works as a plain-CSS copy but is deprecated.
