...
import type EntityCollectionType from "./_internals/data/entity-collection";
...
declare global {
  ...
  namespace EntitySchema {
    type EntityCollection<EntityName extends keyof EntitySchema.Entities> =
      EntityCollectionType<EntityName>;
    type Entity<EntityName extends keyof EntitySchema.Entities> =
