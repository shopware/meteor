...
describe("entity-serializer.ts", () => {
  it("should convert entities", () => {
    ...
    const association = new Entity("bar", "jest-association", {
    ...
    expect(serializedMessageData.entity.hasOwnProperty("__entityName__")).toBe(
      true,
    );
    expect(serializedMessageData.entity.__entityName__).toBe("jest");

    expect(serializedMessageData.entity.hasOwnProperty("__isDirty__")).toBe(
      true,
    );
    ...
    expect(serializedMessageData.entity.hasOwnProperty("__origin__")).toBe(
      true,
    );
    expect(typeof serializedMessageData.entity.__origin__).toBe("object");

    expect(
      serializedMessageData.entity.__origin__.hasOwnProperty("string"),
    ).toBe(true);
    expect(serializedMessageData.entity.__origin__.string).toBe("jest-is-fun");

    expect(
      serializedMessageData.entity.__origin__.hasOwnProperty("number"),
    ).toBe(true);
    expect(serializedMessageData.entity.__origin__.number).toBe(42);

    expect(
      serializedMessageData.entity.__origin__.hasOwnProperty("array"),
    ).toBe(true);
    expect(serializedMessageData.entity.__origin__.array.length).toBe(3);

    expect(
      serializedMessageData.entity.__origin__.hasOwnProperty("object"),
    ).toBe(true);
    expect(typeof serializedMessageData.entity.__origin__.object).toBe(
      "object",
    );
    expect(
      serializedMessageData.entity.__origin__.object.hasOwnProperty("foo"),
    ).toBe(true);
    ...
    expect(
      serializedMessageData.entity.__draft__.hasOwnProperty("string"),
    ).toBe(true);
    expect(serializedMessageData.entity.__draft__.string).toBe(
      "jest-is-more-fun",
    );

    expect(
      serializedMessageData.entity.__draft__.hasOwnProperty("number"),
    ).toBe(true);
    expect(serializedMessageData.entity.__draft__.number).toBe(1337);

    expect(serializedMessageData.entity.__draft__.hasOwnProperty("array")).toBe(
      true,
    );
    expect(serializedMessageData.entity.__draft__.array.length).toBe(4);

    expect(
      serializedMessageData.entity.__draft__.hasOwnProperty("object"),
    ).toBe(true);
    expect(typeof serializedMessageData.entity.__draft__.object).toBe("object");
    expect(
      serializedMessageData.entity.__draft__.object.hasOwnProperty("foo"),
    ).toBe(true);
    expect(serializedMessageData.entity.__draft__.object.foo).toBe("buz");

    expect(
      serializedMessageData.entity.__draft__.hasOwnProperty("association"),
    ).toBe(true);
    expect(typeof serializedMessageData.entity.__draft__.association).toBe(
      "object",
    );
    expect(
      serializedMessageData.entity.__draft__.association.hasOwnProperty(
        "__id__",
      ),
    ).toBe(true);
    expect(serializedMessageData.entity.__draft__.association.__id__).toBe(
      "bar",
    );
    ...
    expect(
      serializedMessageData.entity.__draft__.association.__entityName__,
    ).toBe("jest-association");
    ...
    expect(serializedMessageData.entity.__draft__.association.__isDirty__).toBe(
      true,
    );
    ...
    expect(serializedMessageData.entity.__draft__.association.__isNew__).toBe(
      false,
    );
    ...
    expect(
      typeof serializedMessageData.entity.__draft__.association.__origin__,
    ).toBe("object");
    expect(
      serializedMessageData.entity.__draft__.association.__origin__.hasOwnProperty(
        "string",
      ),
    ).toBe(true);
    expect(
    ...
    expect(
      serializedMessageData.entity.__draft__.association.__draft__.hasOwnProperty(
        "string",
      ),
    ).toBe(true);
    expect(
    ...
    expect(deserializedMessageData.entity.hasOwnProperty("association")).toBe(
      true,
    );
    expect(typeof deserializedMessageData.entity.association).toBe("object");
    expect(typeof deserializedMessageData.entity.association.getDraft).toBe(
      "function",
    );
    ...
    expect(deserializedMessageData.entity.association.string).toBe(
      "jest-is-more-fun",
    );
