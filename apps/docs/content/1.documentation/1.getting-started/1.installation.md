...
To switch language reactively, connect your translation solution (vue-i18n, the Admin SDK,
or anything else), or override Meteor's wording, install the Meteor i18n plugin:
...
All setups, adapters, overriding, and version guidance live on the
[Internationalization page](/documentation/getting-started/internationalization).
