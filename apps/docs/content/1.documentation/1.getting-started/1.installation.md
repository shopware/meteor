...
For the full workflow, including how to build and publish the package from Meteor, see [Local development](/documentation/getting-started/contributing#local-development) in the contributing guide.
...
See [What's new](/documentation/getting-started/whats-new) for the release history of Meteor's documented packages.
