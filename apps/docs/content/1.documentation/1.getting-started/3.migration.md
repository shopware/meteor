...
The component name is the same. The tag just changes from `sw-icon` to `mt-icon`. See the [Icons](/documentation/design/icons) page for the full icon set and usage guidance.
