...
description: The shared product design principles that guide decision making across Shopware's products and the Meteor design system.
---
...
Trust is slow to build and fast to lose. We do not use dark patterns, deceptive defaults, or urgency mechanisms that exploit users. We are transparent about what data is collected, how it is used, and what actions are irreversible. We design for the long-term relationship, not the short-term conversion. The [Wording](/documentation/content/wording) guidelines cover inclusive language and tone of voice that support these principles in copy.
