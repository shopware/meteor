...
Meteor icons follow a minimal, expressive style aligned with Shopware's product language. For technical usage, see the [Icon component](/components/icon) documentation.
