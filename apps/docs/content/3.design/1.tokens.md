...
A design token captures a single decision (a color, a spacing step, a font size) as a named value that both design and code reference. They act as a bridge between design and development, ensuring consistency across different platforms and tools. By abstracting raw values into meaningful names, design tokens enable scalable and maintainable UI systems.
