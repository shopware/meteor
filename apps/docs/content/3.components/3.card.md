---
title: Card
description: Card groups related content, metadata, and local actions inside a bordered surface.
---

::page-header{tag-name="mt-card" status="available" package-imports="MtCard" source-path="packages/component-library/src/components/layout/mt-card"}
...
::component-example{name="ExampleCardBasic"}
::

### Header content

::component-example{name="ExampleCardHeaderContent"}
::

### Tabs

::component-example{name="ExampleCardTabs"}
::

### Loading

::component-example{name="ExampleCardLoading"}
::

### Inheritance

::component-example{name="ExampleCardInheritance"}
::

### Inset content

::component-example{name="ExampleCardInsetContent"}
::

### Inset footer

::component-example{name="ExampleCardInsetFooter"}
::
