---
title: Card
description: Card groups related content, metadata, and local actions inside a bordered surface. Use it to break a page into clearly separated sections without losing the relationship between the content and the actions around it.
meteor:
  tagName: mt-card
  status: deprecated
