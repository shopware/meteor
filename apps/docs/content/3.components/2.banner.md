---
title: Banner
description: Banner displays persistent, inline messaging inside the page layout. Use it when people should notice a status, warning, or informational message while continuing their work in the surrounding interface.
meteor:
  tagName: mt-banner
  status: experimental
...
::component-example{name="ExampleBannerVariants" layout="column"}
::
