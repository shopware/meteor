---
title: Banner
description: Banner displays persistent, inline messaging inside the page layout.
---

::page-header{tag-name="mt-banner" status="available" package-imports="MtBanner" source-path="packages/component-library/src/components/feedback-indicator/mt-banner"}
...
::component-example{name="ExampleBannerBasic"}
::

### Closable

::component-example{name="ExampleBannerClosable"}
::

### Variants

::component-example{name="ExampleBannerVariants"}
::

## API reference

::props-table{component="MtBanner"}
::
