...
::component-example{name="ExampleButtonVariants" layout="row"}
::

### Sizes

::component-example{name="ExampleButtonSizes" layout="row"}
::
...
::component-example{name="ExampleButtonStates" layout="row"}
::
