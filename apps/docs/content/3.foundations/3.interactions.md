---
title: Interactions
description: Guidelines for how interactive elements communicate availability, affordance, and system response across input methods.
---
...
- For operations that take time, show a [Loader](/components/loader) or [Progress Bar](/components/progress-bar) so the user knows work is in progress.
- For completed actions that do not require a new page or view, use a [Snackbar](/components/snackbar) to confirm the outcome without interrupting the flow.
...
For interaction-specific color tokens, see the [Tokens](/foundations/tokens/overview) page.
