---
title: Components
description: How Meteor components are structured, named, and built, including conventions for props, slots, events, and CSS.
---
...
::do-dont{do-text="mt-modal + mt-modal-trigger + mt-modal-action composed by the consumer" dont="one mt-modal with props: showTrigger, triggerLabel, showCloseButton, footerButtonLabel, ..."}
::
...
For detailed accessibility requirements and patterns, see the [Accessibility](/foundations/accessibility) page.
