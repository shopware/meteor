---
title: Interactions
description: Every interactive element should communicate clearly whether it can be used, what will happen, and whether the system has responded.
---
...
For interaction-specific color tokens, see the [Tokens](/foundations/tokens/tokens-overview) page.
