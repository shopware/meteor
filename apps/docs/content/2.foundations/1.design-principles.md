...
description: Shopware's product design principles reflect how we think about design, building the right thing and building the thing right.
---
...
Trust is slow to build and fast to lose. We do not use dark patterns, deceptive defaults, or urgency mechanisms that exploit users. We are transparent about what data is collected, how it is used, and what actions are irreversible. We design for the long-term relationship, not the short-term conversion. The [Voice and Tone](/foundations/content/voice-and-tone) guidelines cover inclusive language and tone of voice that support these principles in copy.
