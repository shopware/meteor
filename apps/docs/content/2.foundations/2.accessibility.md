---
title: Accessibility
description: Meteor ships with built-in accessibility features, and these guidelines help you make your app accessible end-to-end.
---
...
- **Color contrast**: [Design tokens](/foundations/tokens/tokens-overview) meet WCAG 2.1 AA contrast ratios for text and UI elements
