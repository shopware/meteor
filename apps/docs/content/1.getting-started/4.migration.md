---
title: Migration
description: How to transition from older sw- components and the admin-extension-sdk to Meteor.
---
...
| Old component     | Meteor component |
| ----------------- | ---------------- |
| `sw-button`       | `mt-button`      |
...
Replace custom CSS variables or hard-coded colors with [Meteor tokens](/foundations/tokens/tokens-overview):
