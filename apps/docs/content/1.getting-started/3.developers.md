---
description: How to install and use the Meteor component library, design tokens, and icon kit in your project.
---

::page-header{source-url="https://github.com/shopware/meteor"}
::
